...
CwsLabelPosition = Class.create();
CwsLabelPosition.prototype = {
    initialize: function () {
    ...
    registerSelector: function (selectbox, selector, value, input, label) {
        selector.observe(
            'mouseover', (function (event) {
            selector.addClassName('over');}).bind(selector)
        );
        selector.observe(
            'mouseout', (function (event) {
            selector.removeClassName('over');}).bind(selector)
        );
        selector.observe(
            'click', (function (event) { 
...
if(typeof cwsPosition=='undefined') {
    var cwsPosition = new CwsLabelPosition();
}
